...
public class Button6interact : MonoBehaviour
{
    ...
    private GameObject sixthButton;
    void Start()
    {
        ButtTrack = GameObject.Find("Buttons");
        sixthButton = GameObject.Find("Button6");
    }
    ...
    void ReactToRaycast()
    {
        ...
        if (Button1 == true && Button2 == true && Button3 == true && Button4 == true && Button5 == true && Button6 == false && Button7 == false)
        {
            ButtTrack.GetComponent<ButtonTracking>().Button6 = true;
        }
        else
        {
