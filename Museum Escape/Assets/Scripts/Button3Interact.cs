...
public class Button3Interact : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        thirdButton = GameObject.Find("Button3");
    }
    ...
    void ReactToRaycast()
    {
        ...
        if (Button1 == true && Button2 == true && Button3 == false && Button4 == false && Button5 == false && Button6 == false && Button7 == false)
        {
            ButtTrack.GetComponent<ButtonTracking>().Button3 = true;
        }
        else
        {
