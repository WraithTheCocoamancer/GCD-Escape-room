...
public class Button2Interact : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SecondButton = GameObject.Find("Button2");
    }
    ...
    void ReactToRaycast()
    {
        ...
        if (Button1 == true && Button2 == false && Button3 == false && Button4 == false && Button5 == false && Button6 == false && Button7 == false)
        {
            ButtTrack.GetComponent<ButtonTracking>().Button2 = true;
        }
        else
        {
